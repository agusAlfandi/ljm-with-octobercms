 ...
 * Model
 */
class Standar_lampauan extends Model
{
     ...
     */
    public $table = 'agus_tabler_standar_lampauan';
    ...
    protected function uploadFileToGoogleDrive($file)
    {
        try {
            ...
            $category = 'Standar Lampauan';
            // \Log::info('Uploading Standar Lampauan to Google Drive', [
            //     'filePath' => $filePath,
            //     'fileName' => $fileName,
            //     'category' => $category
            // ]);
    ...
    public function afterDelete()
    {
        ...
        if ($this->file_name) {
            try {
                ...
                // \Log::info('afterDelete Standar Lampauan - Debug', [
