 ...
 * Model
 */
class Standar_spmi extends Model
{
     ...
     */
    public $table = 'agus_tabler_standar_spmi';
    ...
    protected function uploadFileToGoogleDrive($file)
    {
        try {
            ...
            $category = 'Standar SPMI';
            // \Log::info('Uploading Standar SPMI to Google Drive', [
            //     'filePath' => $filePath,
            //     'fileName' => $fileName,
            //     'category' => $category
            // ]);
    ...
    public function afterDelete()
    {
        ...
        if ($this->file_name) {
            try {
                ...
                // \Log::info('afterDelete Standar SPMI - Debug', [
