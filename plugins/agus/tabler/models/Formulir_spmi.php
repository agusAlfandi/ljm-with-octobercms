 ...
 * Model
 */
class Formulir_spmi extends Model
{
     ...
     */
    public $table = 'agus_tabler_formulir_spmi';
...
/**
    ...
    protected function uploadFileToGoogleDrive($file)
    {
        try {
            ...
            $category = 'Formulir SPMI';
            // \Log::info('Uploading Formulir SPMI to Google Drive', [
            //     'filePath' => $filePath,
            //     'fileName' => $fileName,
            //     'category' => $category
            // ]);
    ...
    public function afterDelete()
    {
        ...
        if ($this->file_name) {
            try {
                ...
                // \Log::info('afterDelete Formulir SPMI - Debug', [
