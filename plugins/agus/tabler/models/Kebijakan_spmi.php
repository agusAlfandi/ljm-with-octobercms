 ...
 * Model
 */
class Kebijakan_spmi extends Model
{
     ...
     */
    public $table = 'agus_tabler_kebijakan_spmi';
    ...
    protected function uploadFileToGoogleDrive($file)
    {
        try {
            ...
            $category = 'Kebijakan SPMI';
            // \Log::info('Uploading Kebijakan SPMI to Google Drive', [
            //     'filePath' => $filePath,
            //     'fileName' => $fileName,
            //     'category' => $category
            // ]);
    ...
    public function afterDelete()
    {
        ...
        if ($this->file_name) {
            try {
                ...
                // \Log::info('afterDelete Kebijakan SPMI - Debug', [
